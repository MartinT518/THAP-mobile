  ...
  return (
    <Suspense fallback={<PageFallback />}>
      <Switch>
        ...
        <Route path="/help-support">{() => <HelpSupportPage />}</Route>
        ...
        <Route path="/tags">{() => <ProtectedRoute><TagManagement /></ProtectedRoute>}</Route>
        <Route path="/product/:id/edit">{() => <ProtectedRoute><ProductEdit /></ProtectedRoute>}</Route>
        <Route path="/product/:id/register">{() => <ProtectedRoute><ProductRegister /></ProtectedRoute>}</Route>
        ...
        <Route path="/share/:token">{() => <ProtectedRoute><SharedProduct /></ProtectedRoute>}</Route>
